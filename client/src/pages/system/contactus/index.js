...
import imgAboutUs from "../../../assets/imgs/contactus.png";
         ...
         <img src={imgBannerLive} style={{width:"100%"}} />
            <div className="login aboutus">
              ...
              <p><IconButton
                        ...
                        color="white"
                        className="bg-bet-color mr-10"
                    >
                            <NotificationsOutlinedIcon style={{width:"30px",height:"30px",color:"white"}} />
                          
                    </IconButton>
                    <label>+012 2424 2452</label></p>
                    <p><IconButton
                        size="md"
                        aria-label="show 17 new notifications"
                        color="white"
